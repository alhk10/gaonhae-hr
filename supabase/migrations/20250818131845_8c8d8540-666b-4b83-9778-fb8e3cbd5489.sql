...
-- This allows them to clock in from any location if they have approved bookings

-- Add location exceptions for the affected employees
INSERT INTO location_exceptions (employee_id, reason, created_by, enabled, expires_at)
VALUES 
  ('EMP1751007228999', 'Remote work allowance for approved slot booking dates', 'system', true, '2025-12-31 23:59:59'),
  ('EMP1751006564567', 'Remote work allowance for approved slot booking dates', 'system', true, '2025-12-31 23:59:59'), 
  ('EMP1751006728858', 'Remote work allowance for approved slot booking dates', 'system', true, '2025-12-31 23:59:59'),
  ('EMP1751006984631', 'Remote work allowance for approved slot booking dates', 'system', true, '2025-12-31 23:59:59')
ON CONFLICT (employee_id) DO NOTHING;

-- Phase 3: Ensure check_employee_admin_access function properly handles superadmins
-- Update the function to prioritize superadmin status
