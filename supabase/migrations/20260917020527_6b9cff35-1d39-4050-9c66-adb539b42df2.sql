INSERT INTO public.products (sku, name, base_price, is_service, is_active)
SELECT 'COMP-REG', 'Competition Registration', 0, true, true
WHERE NOT EXISTS (SELECT 1 FROM public.products WHERE name = 'Competition Registration');
