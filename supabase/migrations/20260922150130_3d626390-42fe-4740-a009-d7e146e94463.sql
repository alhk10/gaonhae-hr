...
REVOKE ALL ON FUNCTION public.get_public_competition_list(text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_public_competition_list(text) TO anon, authenticated;