...
import { Clock, Building2, Save, Loader2, GraduationCap } from 'lucide-react';
import {
  BranchSchedule,
  WEEKDAYS,
...
import { BranchClassScheduleManagement } from './BranchClassScheduleManagement';
