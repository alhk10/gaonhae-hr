...
const TILES: Tile[] = [
  ...
  { to: '/finance/reports/trial-balance', title: 'Trial Balance',   desc: 'All accounts with debit/credit totals', icon: BarChart3, ready: true },
  { to: '/finance/reports/balance-sheet', title: 'Balance Sheet',   desc: 'Assets, liabilities and equity as of a date', icon: FileSpreadsheet, ready: true },
